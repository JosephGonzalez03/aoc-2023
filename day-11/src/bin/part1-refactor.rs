...
fn solution(input: &str) -> u32 {
    ...
    galaxy_pairs
        ...
        .flatten()
        .map(|(galaxy1, galaxy2)| {
            let empty_rows_between_x_delta = <usize as TryInto<u32>>::try_into(
                empty_rows
                    .clone()
                    .into_iter()
            ...
            .unwrap();
            let empty_columns_between_y_delta = <usize as TryInto<u32>>::try_into(
                empty_columns
                    .clone()
                    .into_iter()
            ...
            .unwrap();
            ((1 * empty_rows_between_x_delta) + galaxy1.row.abs_diff(galaxy2.row))
                + ((1 * empty_columns_between_y_delta) + galaxy1.column.abs_diff(galaxy2.column))
        })
        .sum()
}
